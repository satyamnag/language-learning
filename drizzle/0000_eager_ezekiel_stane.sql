...
CREATE TABLE "challenge_options" (
	...
	"image_src" text DEFAULT '/default.png' NOT NULL,
	"audio_src" text
);
...
ALTER TABLE "pronunciation_history" ADD CONSTRAINT "pronunciation_history_user_id_user_progress_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user_progress"("user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pronunciation_history" ADD CONSTRAINT "pronunciation_history_challenge_id_challenges_id_fk" FOREIGN KEY ("challenge_id") REFERENCES "public"."challenges"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
